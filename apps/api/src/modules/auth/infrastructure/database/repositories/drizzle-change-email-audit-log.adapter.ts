...
import {
	type ChangeEmailAuditEventParams,
...
@Injectable()
export class DrizzleChangeEmailAuditLogAdapter
	implements ChangeEmailAuditLogPort
{
	constructor(
	...
	async log(params: ChangeEmailAuditEventParams): Promise<void> {
		try {
