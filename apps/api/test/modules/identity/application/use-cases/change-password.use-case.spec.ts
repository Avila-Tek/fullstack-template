...
import { InvalidCredentialsException } from '@/modules/identity/domain/exceptions/invalid-credentials.exception';
import { InvalidPasswordException } from '@/modules/identity/domain/exceptions/invalid-password.exception';
import { NoPasswordAccountException } from '@/modules/identity/domain/exceptions/no-password-account.exception';
import { PasswordReuseException } from '@/modules/identity/domain/exceptions/password-reuse.exception';
import type { AccountRepositoryPort } from '@/modules/identity/application/ports/out/account-repository.port';
import type { PasswordHashServicePort } from '@/modules/identity/application/ports/out/password-hash-service.port';
import type { PasswordHistoryRepositoryPort } from '@/modules/identity/application/ports/out/password-history-repository.port';
import type { SessionRepositoryPort } from '@/modules/identity/application/ports/out/session-repository.port';
