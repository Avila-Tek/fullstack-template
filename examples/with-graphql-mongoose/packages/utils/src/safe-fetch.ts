 ...
 *
 * @param {string | URL} input - The input to fetch, similar to the `fetch` API.
 * @param {any} [init] - Optional settings to apply to the request.
 *
 ...
 * ```
 */
export async function safeFetch(input: string | URL, init?: any) {
