...
const htmlElementAttributes: Record<string, Array<string>> = {
  '*': [
    'accesskey',
    'autocapitalize',
    'autocorrect',
...
/** Flat array of HTML attributes. */
export const htmlAttributes = Object.values(htmlElementAttributes).flat();

export function endsWithUnescapedAttribute(acc: string): boolean {
  return htmlAttributes.some((attribute) => acc.endsWith(`${attribute}=`));
}

export const htmlUriAttributes = [
  'action',
  'archive',
  'background',
  'cite',
