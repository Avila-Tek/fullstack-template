...
/**
 * NestJS-injectable wrapper around ZoomAuthClient.
 * Configures the client from env at construction time and exposes
 * the same getToken() / invalidateToken() surface as before.
 */
@Injectable()
